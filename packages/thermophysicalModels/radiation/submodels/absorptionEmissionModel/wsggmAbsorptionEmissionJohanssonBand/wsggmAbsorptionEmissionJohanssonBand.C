...
#include "wsggmAbsorptionEmissionJohanssonBand.H"
...
namespace Foam
{
    namespace radiation
    {
        defineTypeNameAndDebug(wsggmAbsorptionEmissionJohanssonBand, 0);
...
Foam::radiation::wsggmAbsorptionEmissionJohanssonBand::wsggmAbsorptionEmissionJohanssonBand
(
...
Foam::radiation::wsggmAbsorptionEmissionJohanssonBand::aCont(const label bandI) const
{
...
*/
    ...
    forAll(a, i)
    {
        ...
        {
            const absorptionCoeffsJohanssen::coeffArray& b =
...
Foam::tmp<Foam::volScalarField>
Foam::radiation::wsggmAbsorptionEmissionJohanssonBand::ggCoeff(const label bandI) const
{
...
Foam::tmp<Foam::volScalarField>
Foam::radiation::wsggmAbsorptionEmissionJohanssonBand::eCont(const label bandI) const
{
    return aCont(bandI);
}
...
Foam::tmp<Foam::volScalarField>
Foam::radiation::wsggmAbsorptionEmissionJohanssonBand::addIntensity
(
    const label i,
...
void Foam::radiation::wsggmAbsorptionEmissionJohanssonBand::correct
(
    volScalarField& a,
...
void Foam::radiation::wsggmAbsorptionEmissionJohanssonBand::correctEnFrac
(
